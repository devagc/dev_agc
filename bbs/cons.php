        ...
        <fieldset>
            ...
            <div class="field_wrap">
                <div class="field">
                    ...
                    <input type="text" name="text" id="text" maxlength="8" placeholder="" value="" autofocus>
                </div>
                <div class="field">
                    <label for="userpw">연락처</label> <br>
                    <input type="text" name="userpw" id="userpw" placeholder="" value="">
                </div>
            </div>
            <div class="title">
...
개인정보를 보관하고 있는 물리적 보관 장소를 별도로 두고 이에 대해 출입통제 절차를 수립, 운영하고 있습니다.
            ...
            <div class="field_5">
                <label><input type="checkbox" name="" value=""> 위 개인정보처리방침에 동의합니다.</label>
            </div>
        </fieldset>
        <div class="btn_area">
