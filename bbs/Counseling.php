...
<body>
    ...
    <div class="wrea">
        ...
        <div class="content s1140">
            <form action="#" method="POST" enctype="multipart/form-data">
                <!-- <h2>상담 신청</h2> -->
                <div class="form s1140">
                    <div class="form_wrap">
                    <div class="title">
                        <h3>1. 간단한 정보만 알려주세요</h3>
                    </div>
                        <div class="input_wrap s1140">
                            <div class="item">
                                <p>이름</p>
                                <div>
                                    <input type="text" name="s-v1" id="s-v1">
                                </div>
                            </div>
                            <div class="item">
                                <p>연락처</p>
                                <div>
                                    <input type="text" name="s-v2" id="s-v2">
                                </div>
                            </div>
                            <div class="item">
                                <p>업체/회사면</p>
                                <div>
                                    <input type="text" name="s-v3" id="s-v3">
                                </div>
                            </div>
                            <div class="item">
                                <p>이메일</p>
                                <div>
                                    <input type="email" name="s-v4" id="s-v4">
                                </div>
                            </div>
                        </div>
                        <div class="title">
                        ...
                        <div class="field">
                            <label><input type="checkbox" name="" value=""> Wep site (홈페이지 제작)</label>
                            <label><input type="checkbox" name="" value=""> Shopping Mall (쇼핑몰 제작)</label>
                            <label><input type="checkbox" name="" value=""> Mobile Web (모바일웹 제작)</label>
                            <label><input type="checkbox" name="" value=""> App (앱제작)</label>
                            <label><input type="checkbox" name="" value=""> The others (기타)</label>
                        </div>
                        <div class="title">
                            <h3>3.예산과 일정은 어떻게 되나요? <span>아래 항목을 선택해주세요.</span> </h3>
                        </div>
                        <div class="item_wrap s1140">
                            <div class="item">
                                <div>
                                    <select name="s_v6" id="s_v6">
                        ...
                        <div class="txt_box">
                            <div class="long_item">
                                <textarea name="s_t1" id="s_t1" cols="30" rows="10"></textarea>
                            </div>
                            <div class="long_item s1140">
                                <div class="field">
...
개인정보를 보관하고 있는 물리적 보관 장소를 별도로 두고 이에 대해 출입통제 절차를 수립, 운영하고 있습니다.
                        ...
                        <div class="chek_rg">
                            <label><input type="checkbox" name="" value=""> 위 개인정보처리방침에 동의합니다.</label> <br>

                            
                            <button type="submit" class="a">신청하기</button>
                        </div>
                    </div>
                    </div>
            </form>            
