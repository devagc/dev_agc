<div class="po_nav">
            <ul>
                <li class="" id="li"><a href="index.php?id=all" class="a"><img src="img/all.png" alt=""><span>all</span></a></li>
                ...
                <li class="active" id="li"><a href="index.php?id=ems" class="a"><img src="img/prog.png" alt=""><span>EMS</span></a></li>
            </ul>
        </div>
    </div>
